...
@section('content')
    @php $produitsSelectionnes = old('produits', $categorie->produits->pluck('id')->all()); @endphp
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.categories.update', $categorie) }}">
                ...
                <div class="mb-3">
                    ...
                    <x-text-input id="nom" name="nom" type="text" class="mt-1" :value="old('nom', $categorie->nom)" required autofocus />
